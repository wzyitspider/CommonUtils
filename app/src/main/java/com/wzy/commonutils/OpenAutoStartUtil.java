...
//                        "com.huawei.systemmanager.optimize.process.ProtectActivity");
                ...
                if (Build.VERSION.SDK_INT >= 9) {
                    intent.setAction("android.ic_launcher.APPLICATION_DETAILS_SETTINGS");
                    intent.setData(Uri.fromParts("package", context.getPackageName(), null));
                } else if (Build.VERSION.SDK_INT <= 8) {
                    intent.setAction(Intent.ACTION_VIEW);
                    intent.setClassName("com.android.ic_launcher",
                            "com.android.ic_launcher.InstalledAppDetails");
                    intent.putExtra("com.android.ic_launcher.ApplicationPkgName",
